...
const useApp = ({ themes, updatePwa }) => {
  ...
  const [activeTheme, setActiveTheme] = useState(themes.darkTheme);
  ...
  return { isLoading, isSupported, activeTheme, appSnackOpen, router, queryClient };
};
