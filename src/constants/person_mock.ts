const PERSON_MOCK = [
  ...
  // ─── International Singles ────────────────────────────
    ...
    ['male', 'Luca', 'Ferretti', '1991/4/21', '401 Fourth Street Dallas', 'luca.ferretti@example.com', '+92 468-541-7133'],
    ['male', 'Bohdan', 'Tkachenko', '1993/6/2', '1578 Fourth Street Columbus', 'bohdan.tkachenko@example.com', '+1 341-597-6694'],
    ['female', 'Yaroslava', 'Bondarenko', '1996/2/5', '1065 Lincoln Street Dallas', 'yaroslava.bondarenko@example.com', '+61 708-508-4638'],
    ['female', 'Larissa', 'Oliveira', '1994/12/25', '1163 Pine Street Los Angeles', 'larissa.oliveira@example.com', '+44 254-761-6843'],
    ['male', 'Gustavo', 'Souza', '1992/12/3', '1946 Oak Street Phoenix', 'gustavo.souza@example.com', '+1 808-757-9867'],
    ['female', 'Mariana', 'Lopes', '1998/8/19', '1837 Maple Street Indianapolis', 'mariana.lopes@example.com', '+1 240-833-4680'],
    ['male', 'Goncalo', 'Mendes', '1990/7/23', '356 Pine Street San Jose', 'goncalo.mendes@example.com', '+49 584-501-9302'],
    ['female', 'Ximena', 'Flores', '1997/11/18', '21 Cedar Street San Francisco', 'ximena.flores@example.com', '+92 957-686-6804'],
    ['male', 'Mateo', 'Ramirez', '1994/9/23', '164 Elm Street Phoenix', 'mateo.ramirez@example.com', '+91 857-765-4373'],
    ['male', 'Miguel', 'Bautista', '1993/1/14', '1964 Fifth Street Dallas', 'miguel.bautista@example.com', '+49 980-340-5333'],
    ['female', 'Rizalina', 'Villanueva', '1996/4/20', '419 Elm Street Seattle', 'rizalina.villanueva@example.com', '+61 837-389-4095'],
    ['male', 'Lukas', 'Zimmermann', '1992/3/25', '560 Fifth Street Seattle', 'lukas.zimmermann@example.com', '+61 411-514-5320'],
    ['female', 'Lena', 'Schaefer', '1995/4/6', '590 Lincoln Street Houston', 'lena.schaefer@example.com', '+44 687-435-7119'],
    ['female', 'Yuki', 'Tanaka', '1996/6/16', '98 Tenth Street San Antonio', 'yuki.tanaka@example.com', '+61 932-569-4853'],
    ['male', 'Kwame', 'Mensah', '1991/8/21', '1999 Seventh Street San Diego', 'kwame.mensah@example.com', '+44 254-655-6112'],
    ['female', 'Priya', 'Sharma', '1997/11/1', '25 Sixth Street San Diego', 'priya.sharma@example.com', '+61 333-911-3476'],
    ['male', 'Andrei', 'Popescu', '1993/2/2', '666 Fourth Street Phoenix', 'andrei.popescu@example.com', '+92 556-625-4398'],
    ['female', 'Fatou', 'Diallo', '1998/6/14', '55 Madison Street Chicago', 'fatou.diallo@example.com', '+49 212-856-4272'],
    ['male', 'Jinsoo', 'Park', '1994/6/18', '968 Elm Street San Diego', 'jinsoo.park@example.com', '+91 730-486-3735'],
    ['female', 'Amara', 'Okafor', '1995/12/21', '1419 Pine Street Columbus', 'amara.okafor@example.com', '+91 322-775-7582'],
    ['male', 'Ravi', 'Patel', '1990/11/6', '926 Elm Street Jacksonville', 'ravi.patel@example.com', '+92 378-326-3439'],
    ['female', 'Annika', 'Lindqvist', '1997/9/17', '1423 Main Street Jacksonville', 'annika.lindqvist@example.com', '+1 465-379-7226'],
    ['male', 'Kofi', 'Asante', '1992/12/23', '1957 Cedar Street Seattle', 'kofi.asante@example.com', '+49 550-430-8269'],
    ['female', 'Meiling', 'Chen', '1996/4/22', '1094 Adams Street San Antonio', 'meiling.chen@example.com', '+44 926-778-4653'],
    ['male', 'Sergei', 'Volkov', '1991/6/26', '1486 Second Street Chicago', 'sergei.volkov@example.com', '+49 328-635-8057'],
    ['female', 'Aiko', 'Watanabe', '1998/6/17', '1506 Jefferson Street Austin', 'aiko.watanabe@example.com', '+91 458-289-9756'],
    ['male', 'Emmanuel', 'Mbeki', '1993/11/10', '1795 Seventh Street Columbus', 'emmanuel.mbeki@example.com', '+44 540-488-4436'],
    ['female', 'Ingrid', 'Haugen', '1994/3/15', '447 Ninth Street Dallas', 'ingrid.haugen@example.com', '+92 896-206-1901'],
  ...
  // ─── American/English Singles ─────────────────────────
    ...
    ['female', 'Natalie', 'Harris', '1996/6/1', '1553 Sixth Street San Diego', 'natalie.harris@example.com', '+44 434-406-8551'],
    ['male', 'Jack', 'Ward', '1995/4/8', '240 Jefferson Street San Jose', 'jack.ward@example.com', '+61 386-511-8949'],
    ['female', 'Harper', 'Turner', '1991/10/3', '639 Fourth Street Denver', 'harper.turner@example.com', '+92 657-388-7474'],
    ...
    ['male', 'Owen', 'Fisher', '1993/12/7', '236 Lincoln Street Jacksonville', 'owen.fisher@example.com', '+44 618-916-5243'],
    ['male', 'Benjamin', 'Foster', '1990/9/16', '244 Second Street Austin', 'benjamin.foster@example.com', '+91 624-944-2089'],
    ['female', 'Hannah', 'Robinson', '1995/4/19', '1813 Ninth Street Chicago', 'hannah.robinson@example.com', '+44 663-850-4302'],
    ['male', 'Jacob', 'Cooper', '1993/9/14', '571 Washington Street Charlotte', 'jacob.cooper@example.com', '+44 907-679-1302'],
    ['male', 'Eli', 'Bennett', '1995/10/2', '1858 Madison Street San Antonio', 'eli.bennett@example.com', '+92 260-518-7256'],
    ['female', 'Grace', 'Perry', '1998/12/1', '1466 Oak Street Los Angeles', 'grace.perry@example.com', '+44 371-964-4017'],
    ['male', 'Nathan', 'Dixon', '1990/9/25', '1110 Seventh Street San Diego', 'nathan.dixon@example.com', '+61 456-307-5568'],
