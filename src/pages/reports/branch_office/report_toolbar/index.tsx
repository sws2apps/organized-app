  ...
  return (
    <StyledBox laptopView={laptopView}>
      <StyledSelect
        ...
        onChange={(e) =>
          setData({ ...data, selectedYear: parseInt(e.target.value) })
        }
      ...
      {reportType === 's1' && (
        <StyledSelect
          label={t('tr_month')}
          onChange={(e) =>
            setData({ ...data, selectedMonth: parseInt(e.target.value) })
          }
      ...
      <StyledButton
        ...
        onClick={() =>
          onGenerateReport(
            data,
            yearsList[data.selectedYear],
            monthList[data.selectedMonth]
          )
        }
      >
