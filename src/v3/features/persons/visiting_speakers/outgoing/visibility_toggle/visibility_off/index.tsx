...
const VisibilityOffConfirm = ({ open, onClose, onConfirm }: VisibilityOffConfirmType) => {
  ...
  return (
    <Dialog onClose={onClose} open={open} sx={{ padding: '24px' }}>
      <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <TextMarkup className="body-regular" color="var(--grey-400)" content={t('tr_outgoingSpeakersHideDesc')} />
      </Box>
