...
const OutgoingSpeakersListActive = ({ congregations, onDelete }: OutgoingSpeakersListActiveType) => {
    ...
    <Box sx={{ display: 'flex', gap: '16px', flexDirection: 'column' }}>
      ...
      >
        {congregations.map((congregation) => (
          <CongregationItem key={congregation.cong_id} congregation={congregation} onDelete={onDelete} />
        ))}
      </Box>
    </Box>
  );
