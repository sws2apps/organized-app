  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <MeetingTime
        ...
        time={generateDateFromTime(congregation.cong_data.midweek_meeting.time.value)}
      ...
      <MeetingTime
        ...
        time={generateDateFromTime(congregation.cong_data.weekend_meeting.time.value)}
