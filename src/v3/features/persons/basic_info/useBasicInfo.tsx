...
import { autoGenerateDisplayNameState } from '@states/settings';
...
const useBasicInfo = () => {
  ...
  const handleChangeFirstname = async (value: string) => {
    ...
    const dispName = generateDisplayName(newPerson.person_lastname.value, value, autogenerateDN);
  ...
  const handleChangeLastname = async (value: string) => {
    ...
    const dispName = generateDisplayName(value, newPerson.person_firstname.value, autogenerateDN);
    newPerson.person_displayName.value = dispName;
    newPerson.person_displayName.updatedAt = new Date().toISOString();
