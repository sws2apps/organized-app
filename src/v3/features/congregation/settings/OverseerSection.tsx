...
import { CardSection, CardSectionContent, CardSectionHeader, TwoColumnsRow } from './CardSection';
  ...
  return (
    <CardSection>
      <CardSectionContent sx={{ gap: '16px' }}>
        <CardSectionHeader title={t('tr_circuitOverseer')} description={t('tr_circuitOverseerSettingDesc')} />
        <TwoColumnsRow>
          <TextField type="text" label={t('tr_name')} value={name} onChange={(e) => setName(e.target.value)} />
          <TextField
            type="text"
