  ...
  return (
    <CardSection>
      <CardSectionContent sx={{ gap: '16px' }}>
        <CardSectionHeader title={t('tr_congregationPrivacy')} description={t('tr_congregationSecurityDesc')} />
        <SwitchItem
      ...
      <CardSectionContent sx={{ gap: '16px' }}>
        <CardSectionHeader title={t('tr_congregationAccessCode')} description={t('tr_congregationAccessCodeDesc')} />
        <TextField
          type="password"
          variant="outlined"
          autoComplete="off"
