    ...
    >
      ...
      {weekDateLocale.length > 0 && (
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <Box sx={{ flex: 1, alignSelf: laptopUp ? 'center' : 'flex-start' }}>
              <ButtonGroup
                buttons={[
                  ...
                  { children: t('tr_editParts'), onClick: handleEditParts, className: isEdit ? 'active' : '' },
                ]}
              />
            </Box>
          ...
          {hasSource && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {weekType !== Week.NORMAL && weekType !== Week.CO_VISIT && <EventEditor meeting="midweek" week={selectedWeek} />}
              ...
              {(weekType === Week.NORMAL || weekType === Week.CO_VISIT) && (
                <>
                  ...
                  <RowContainer desktopUp={desktopUp} sx={{ alignItems: desktopUp ? 'center' : 'flex-start' }}>
