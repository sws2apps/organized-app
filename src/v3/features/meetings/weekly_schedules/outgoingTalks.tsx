...
import { IconCongregation, IconInfo, IconWatchtowerStudy } from '@components/icons';
        ...
        <ScheduleItem>
          <Box>
            <ScheduleTitle color="var(--weekend-meeting)">
              Public talk — <IconCongregation sx={{ margin: '0px 6px !important' }} color="var(--weekend-meeting)" />{' '}
              Berdychyv-Ost
            </ScheduleTitle>
