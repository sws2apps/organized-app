      ...
      <Box>
              ...
              <>
                <IconButton sx={{ padding: 0 }} onClick={handleOpenHistory}>
                  <IconAssignmetHistory
                    color={decorator === 'error' ? 'var(--red-main)' : decorator === 'warning' ? 'var(--orange-dark)' : 'var(--accent-main)'}
                  />
                </IconButton>
              </>
            ) : null
        ...
        {helperText.length > 0 && (
          <Typography
            ...
            color={decorator === 'error' ? 'var(--red-main)' : 'var(--orange-dark)'}
            sx={{ padding: '4px 16px 0 16px', maxWidth: desktopUp ? '350px' : '100%' }}
          >
            {helperText}
          </Typography>
        )}
