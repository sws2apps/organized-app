...
const useAssignmentsHistory = (history: AssignmentHistoryType[]) => {
  ...
  const tableColumns: Column[] = [
    { id: 'history_date', label: t('tr_date'), sx: { width: '104px', backgroundColor: 'unset' } },
    { id: 'history_assignment', label: t('tr_assignment'), sx: { minWidth: '310px', backgroundColor: 'unset' } },
    { id: 'history_hall', label: t('tr_hall'), sx: { width: '80px', backgroundColor: 'unset', textAlign: 'center' } },
  ];
