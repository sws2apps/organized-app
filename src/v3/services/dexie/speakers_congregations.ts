...
export const dbSpeakersCongregationsDummy = async () => {
  ...
  cong1.cong_data.cong_circuit = { value: '01-A', updatedAt: new Date().toISOString() };
  cong1.cong_data.cong_location = {
    address: { value: 'Congregation 1 Kingdom Hall Address', updatedAt: new Date().toISOString() },
    lat: -18.91,
    lng: 47.64,
  };
  cong1.cong_data.cong_name = { value: 'Congregation 1', updatedAt: new Date().toISOString() };
  cong1.cong_data.cong_number = { value: '10001', updatedAt: new Date().toISOString() };
  cong1.cong_data.coordinator = {
    name: { value: 'Coordinator 1', updatedAt: new Date().toISOString() },
    email: { value: 'coordinator1@fakemail.com', updatedAt: new Date().toISOString() },
    phone: { value: '+81 965-431-3024', updatedAt: new Date().toISOString() },
  };
  cong1.cong_data.public_talk_coordinator = {
    name: { value: 'Public Talk Coordinator 1', updatedAt: new Date().toISOString() },
    email: { value: 'public-talk-coordinator1@fakemail.com', updatedAt: new Date().toISOString() },
  ...
  cong2.cong_data.cong_circuit = { value: '26-D', updatedAt: new Date().toISOString() };
  cong2.cong_data.cong_location = {
    address: { value: 'Congregation 2 Kingdom Hall Address', updatedAt: new Date().toISOString() },
    lat: -18.91,
    lng: 47.64,
  };
  cong2.cong_data.cong_name = { value: 'Congregation 2', updatedAt: new Date().toISOString() };
  cong2.cong_data.cong_number = { value: '56239', updatedAt: new Date().toISOString() };
  cong2.cong_data.coordinator = {
    name: { value: 'Coordinator 2', updatedAt: new Date().toISOString() },
    email: { value: 'coordinator2@fakemail.com', updatedAt: new Date().toISOString() },
    phone: { value: '+91 936-400-4116', updatedAt: new Date().toISOString() },
  };
  cong2.cong_data.public_talk_coordinator = {
    name: { value: 'Public Talk Coordinator 2', updatedAt: new Date().toISOString() },
    email: { value: 'public-talk-coordinator2@fakemail.com', updatedAt: new Date().toISOString() },
