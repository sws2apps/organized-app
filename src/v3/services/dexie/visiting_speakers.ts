...
export const dbVisitingSpeakersDummy = async () => {
  ...
  for (const cong of incomingCongs) {
    ...
    speaker1.speaker_data = {
      ...
      person_firstname: { value: 'Ribeiro', updatedAt: new Date().toISOString() },
      person_lastname: { value: 'Gonzaga', updatedAt: new Date().toISOString() },
      person_display_name: {
        value: generateDisplayName('Gonzaga', 'Ribeiro'),
        updatedAt: new Date().toISOString(),
      },
      person_email: { value: 'ribeiro-gonzaga@fakemail.com', updatedAt: new Date().toISOString() },
    ...
    speaker2.speaker_data = {
      ...
      person_firstname: { value: 'Konsta', updatedAt: new Date().toISOString() },
      person_lastname: { value: 'Manninen', updatedAt: new Date().toISOString() },
      person_display_name: {
        value: generateDisplayName('Manninen', 'Konsta'),
        updatedAt: new Date().toISOString(),
      },
      person_email: { value: 'konsta-manninen@fakemail.com', updatedAt: new Date().toISOString() },
