...
export const dbVisitingSpeakersDummy = async () => {
  ...
  const elligiblePersons = persons.filter((record) =>
    record.person_data.assignments.find((assignment) => assignment.code === AssignmentCode.WM_Speaker)
  );

  // add outgoing speakers
  const localCong = congregations.find(
    (record) => record.cong_data.cong_number.value === settings.cong_settings.cong_number
  );
  ...
  speaker1.speaker_data.talks = [
    { _deleted: false, talk_number: 6, talk_songs: [44, 131], updatedAt: new Date().toISOString() },
    { _deleted: false, talk_number: 26, talk_songs: [20, 34, 99], updatedAt: new Date().toISOString() },
  ];
  ...
  speaker2.speaker_data.talks = [
    { _deleted: false, talk_number: 36, talk_songs: [1, 144], updatedAt: new Date().toISOString() },
    { _deleted: false, talk_number: 150, talk_songs: [45, 120], updatedAt: new Date().toISOString() },
  ];
  ...
  for (const cong of incomingCongs) {
    ...
    speaker1.speaker_data = {
      ...
      person_firstname: { value: 'Firstname 1', updatedAt: new Date().toISOString() },
      person_lastname: { value: 'Speaker', updatedAt: new Date().toISOString() },
      person_display_name: {
        value: generateDisplayName('Speaker', 'Firstname 1'),
        updatedAt: new Date().toISOString(),
      },
      person_email: { value: 'speaker-firstname1@fakemail.com', updatedAt: new Date().toISOString() },
      person_notes: { value: '', updatedAt: new Date().toISOString() },
      person_phone: { value: '+61 929-572-140', updatedAt: new Date().toISOString() },
      talks: [
        { _deleted: false, talk_number: 40, talk_songs: [8, 16], updatedAt: new Date().toISOString() },
        { _deleted: false, talk_number: 77, talk_songs: [20, 34, 99], updatedAt: new Date().toISOString() },
      ],
    };
    ...
    speaker2.speaker_data = {
      ...
      person_firstname: { value: 'Firstname 2', updatedAt: new Date().toISOString() },
      person_lastname: { value: 'Speaker', updatedAt: new Date().toISOString() },
      person_display_name: {
        value: generateDisplayName('Speaker', 'Firstname 2'),
        updatedAt: new Date().toISOString(),
      },
      person_email: { value: 'speaker-firstname2@fakemail.com', updatedAt: new Date().toISOString() },
      person_notes: { value: 'Note about speaker', updatedAt: new Date().toISOString() },
      person_phone: { value: '+92 378-326-3439', updatedAt: new Date().toISOString() },
      talks: [
        { _deleted: false, talk_number: 52, talk_songs: [123, 151], updatedAt: new Date().toISOString() },
        { _deleted: false, talk_number: 85, talk_songs: [11, 38], updatedAt: new Date().toISOString() },
      ],
    };
