...
import { Types } from "./page_title_constants";
      ...
      case Types.WITH_BTN:
        return (
          <Button
            ...
            disableAutoStretch
          >
            <Typography variant="button-caps" sx={buttonTextStyle}>{actionText}</Typography>
          </Button>
        );
        ...
        return (
          <Box sx={{ display: 'flex', gap: '16px' }}>
            <Button
              ...
              disableAutoStretch
            >
              <Typography variant="button-caps" sx={{ ...buttonTextStyle, color: "var(--accent-main, #5065D0)" }}>{secondaryActionText}</Typography>
            </Button>
            <Button
              sx={buttonBoxStyle}
              variant="main"
