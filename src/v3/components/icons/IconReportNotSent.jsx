...
const IconReportNotSent = ({ color = '#222222', width = 24, height = 24, sx = {} }) => {
  width = width.toString();
  height = height.toString();

  return (
    <SvgIcon id="organized-icon-report-not-sent" sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
