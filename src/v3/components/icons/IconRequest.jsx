...
const IconRequest = ({ color = '#222222', width = 24, height = 24, sx = {} }) => {
  width = width.toString();
  height = height.toString();

  return (
    <SvgIcon id="organized-icon-request" sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g mask="url(#mask0_2568_27264)">
          ...
          />
          <path
            d="M13.0543 14.6L12.0005 15.6538L8.34668 12L12.0005 8.34619L13.0543 9.40002L11.2197 11.25H15.6543V12.75H11.2197L13.0543 14.6Z"
            fill={color}
          />
        </g>
      </svg>
