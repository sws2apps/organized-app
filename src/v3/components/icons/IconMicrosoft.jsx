...
const IconMicrosoft = ({ width = 24, height = 24, sx = {} }) => {
    ...
    <SvgIcon sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
      <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g clipPath="url(#clip0_2633_30355)">
          ...
          <path d="M11.2935 11.25V0H0.793457C0.379457 0 0.043457 0.336 0.043457 0.75V11.25H11.2935Z" fill="#F44336" />
          <path
            d="M11.2935 12.75H0.043457V23.25C0.043457 23.664 0.379457 24 0.793457 24H11.2935V12.75Z"
            fill="#2196F3"
          />
          <path d="M12.7935 12.75V24H23.2935C23.7075 24 24.0435 23.664 24.0435 23.25V12.75H12.7935Z" fill="#FFC107" />
        </g>
        <defs>
