...
const IconPanelClose = ({ color = '#222222', width = 24, height = 24, sx = {} }: IconProps) => {
  return (
    <SvgIcon id="organized-icon-panel-close" sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
