    ...
    <SvgIcon id="organized-icon-resume" sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          ...
          <path d="M14.596 15.7505H13.0961V8.25052H14.596V15.7505Z" fill="#D9D9D9" />
        </mask>
        <g mask="url(#mask0_3904_134786)">
          <path
            ...
            fill={color}
          />
          <path d="M17.6909 12.0003L11.7949 15.7867V8.21387L17.6909 12.0003Z" fill={color} />
          <path d="M10.0151 15.7504H8.51514V8.25049H10.0151V15.7504Z" fill={color} />
        </g>
      </svg>
    </SvgIcon>
  );
