...
const IconPause = ({ color = '#222222', width = 24, height = 24, sx = {} }: IconProps) => {
  return (
    <SvgIcon id="organized-icon-pause" sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
