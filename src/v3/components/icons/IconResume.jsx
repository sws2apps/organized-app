...
const IconResume = ({ color = '#222222', width = 24, height = 24, sx = {} }) => {
  width = width.toString();
  height = height.toString();

  return (
    <SvgIcon id="organized-icon-resume" sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        >
          ...
          <path d="M14.596 15.75H13.0961V8.25003H14.596V15.75Z" fill="#D9D9D9" />
        </mask>
        <g mask="url(#mask0_3904_134786)">
          <path
            ...
            fill={color}
          />
          <path d="M17.6909 12L11.7949 15.7865V8.21362L17.6909 12Z" fill={color} />
          <path d="M10.0149 15.75H8.51489V8.25H10.0149V15.75Z" fill={color} />
        </g>
      </svg>
    </SvgIcon>
  );
