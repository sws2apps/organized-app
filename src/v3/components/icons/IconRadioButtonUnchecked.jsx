...
const IconRadioButtonUnchecked = ({ color = '#222222', width = 24, height = 24, sx = {} }) => {
  width = width.toString();
  height = height.toString();

  return (
    <SvgIcon id="organized-icon-radio-button-unchecked" sx={{ width: `${width}px`, height: `${height}px`, ...sx }}>
