...
import { MeetingAttendanceTotalBoxProps, MeetingAttendanceTotalBoxType } from './index.types';
...
export const MeetingAttendanceTotalBox = (props: MeetingAttendanceTotalBoxProps) => {
  return (
    <StyledColorBox backgroudColor={getBackgroundColor(props.type)}>
      <Typography className="H4" color={getValueColor(props.type)} sx={{ textAlign: 'center' }}>
        {props.value}
      </Typography>
      <Typography className="label-small-regular" color={getLabelColor(props.type)} sx={{ textAlign: 'center' }}>
        {props.label}
      </Typography>
    </StyledColorBox>
  );
