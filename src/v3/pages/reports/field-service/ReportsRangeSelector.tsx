...
const ReportsRangeSelector = () => {
  ...
  return (
    <StyledCardBox>
      <HorizontalFlex>
        <TextField select label={t('tr_serviceYear')} value={year} onChange={(e) => setYear(e.target.value)}>
          <MenuItem value="2024">2024</MenuItem>
        </TextField>
        <TextField select label={t('tr_month')} value={month} onChange={(e) => setMonth(e.target.value)}>
      ...
      <TextField select defaultValue="all" value={group} onChange={(e) => setGroup(e.target.value)}>
        ...
        <MenuItem value="unbaptizedPub">{t('tr_unbaptizedPublishers')}</MenuItem>
