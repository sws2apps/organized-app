...
const CreateNewGroupModalWindow = (props: CreateNewGroupModalWindowProps) => {
  ...
  const [creatingGroupFinnalyStage, setCreatingGroupFinnalyStage] = useState(false);
  ...
  return !creatingGroupFinnalyStage ? (
    <StyledModalWindowConatiner className="pop-up-shadow">
      ...
      >
        <CustomTypography className="h2">{t('tr_createNewGroupTitle')}</CustomTypography>
      ...
      >
        ...
        >
          <CustomTextField select label={t('tr_groupOverseer')} sx={{ flex: 1 }} />
          <CustomTextField select label={t('tr_groupOverseerAssistant')} sx={{ flex: 1 }} />
        </Box>
      </Box>
      ...
      >
        <CustomButton variant="main" onClick={() => setCreatingGroupFinnalyStage(true)}>
          {t('tr_next')}
        </CustomButton>
    ...
    <StyledModalWindowConatiner className="pop-up-shadow">
      ...
      >
        <CustomTypography className="h2">{t('tr_groupNumber', { groupNumber: groupNumber })}</CustomTypography>
        <CustomTypography className="body-regular" color={'var(--grey-400)'}>
      ...
      >
        ...
        <CustomButton variant="secondary" onClick={() => setCreatingGroupFinnalyStage(false)}>
          {t('tr_back')}
        </CustomButton>
      </Box>
    </StyledModalWindowConatiner>
