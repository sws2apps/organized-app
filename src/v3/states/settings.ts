...
export const midweekMeetingDayState = selector({
  ...
  get: ({ get }) => {
    ...
    return settings.midweek_meeting_day || 2;
  },
});
...
export const meetingTimeState = selector({
  ...
  get: ({ get }) => {
    ...
    return settings.meeting_time || new Date().toISOString();
  },
});
...
export const autoGenerateDisplayNameState = selector({
  key: 'autoGenerateDisplayName',
  get: ({ get }) => {
    const settings = get(settingsState);

    return settings.autogenerate_display_name?.value ?? false;
  },
});
...
export const accountTypeState = selector({
  ...
  get: ({ get }) => {
    ...
    return (settings.account_type as AccountTypeState) || 'vip';
  },
});
...
export const weekendMeetingDayState = selector({
  ...
  get: ({ get }) => {
    ...
    return settings.weekend_meeting_day || 7;
  },
});
...
export const congDiscoverableState = selector({
  ...
  get: ({ get }) => {
    ...
    return settings.cong_discoverable?.value || false;
  },
});
