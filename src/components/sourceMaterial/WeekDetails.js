            ...
            >
                ...
                >
                    ...
                    <FormControlLabel
                        ...
                        label={hasMeeting ? "Misy fivoriana" : "Tsy misy fivoriana"}
                    />
                </Box>
                ...
                <Box sx={sharedStyles.ayfStuPart}>
                    <Typography variant="body1" sx={sharedStyles.partHeader}>Anjara 1</Typography>
                ...
                <Box sx={sharedStyles.ayfStuPart}>
                    <Typography variant="body1" sx={sharedStyles.partHeader}>Anjara 2</Typography>
                    <Box sx={sharedStyles.ayfStuPartInfo}>
                        <PartDuration
                            ayf={2}
                            assTime={Ass2Time}
                ...
                <Box sx={sharedStyles.ayfStuPart}>
                    <Typography variant="body1" sx={sharedStyles.partHeader}>Anjara 3</Typography>
                    <Box sx={sharedStyles.ayfStuPartInfo}>
                        <PartDuration
                            ayf={3}
                            assTime={Ass3Time}
                ...
                <Box sx={sharedStyles.ayfStuPart}>
                    <Typography variant="body1" sx={sharedStyles.partHeader}>Anjara 4</Typography>
                    <Box sx={sharedStyles.ayfStuPartInfo}>
                        <PartDuration
                            ayf={4}
                            assTime={Ass4Time}
