...
import { dbGetPersonsByAssType, dbHistoryAssignment, dbHistoryAssistant } from "../../indexedDb/dbPersons";
...
const StudentSelector = (props) => {
    ...
    useEffect(() => {
        ...
        const loadStudents = async () => {
            var students = [];
            if (assID === 3 || assID === 5 || assID === 7 || assID === 9 || assID === 11 || assID === 13 || assID === 15 || assID === 17) {
            ...
            if (assID === 3 || assID === 5 || assID === 7 || assID === 9 || assID === 11 || assID === 13 || assID === 15 || assID === 17) {
                ...
                filteredHistory = history.filter(item => item.assignmentID === assType);
            }
    ...
    return ( 
        <>
            ...
            {(assID === 3 || assID === 5 || assID === 7 || assID === 9 || assID === 11 || assID === 13 || assID === 15 || assID === 17) && (
                <>
                    <Typography
                        variant="body2"
                        sx={{
            ...
            <Typography variant="body2" sx={sharedStyles.tableHeader}>Afaka manao ny anjara</Typography>
            {isLoadingStudent && (
            ...
            {selectedStudent !== "" && (
                <>
                    <Typography variant="body2" sx={sharedStyles.tableHeader}>{selectedStudent} (Anjara efa nataony)</Typography>
                    {isLoadingStuHistory && (
                        <CircularProgress
                            color="secondary"
                            size={30}
                                    ...
                                    <TableBody>
                                        {stuHistory.map(history => (
                                            <TableRow key={history.ID} hover role="checkbox" tabIndex={-1}>
                                                ...
                                                <TableCell sx={{'& .MuiTableCell-sizeSmall': sharedStyles.tblData}}>{history.assignmentName}</TableCell>
                                                <TableCell 
                                                    align="center"
