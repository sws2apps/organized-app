# Organized App — Agent Guidelines
...
Fill in the body based on `.github/PULL_REQUEST_TEMPLATE.md`. Delete checklist items that are not relevant to keep the description clean.
